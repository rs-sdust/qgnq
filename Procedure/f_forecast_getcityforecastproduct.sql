CREATE OR REPLACE FUNCTION f_forecast_getcityforecastproduct(IN sdate varchar, IN iprodtype int4, IN icroptype int4, IN idiseasetype int4, IN iregionid int4) 
