...
namespace WebApi.Controllers
{
    public class ForecastController : ApiController
    {
        ...
        {
            string str = string.Format("SELECT * FROM f_forecast_getprovforecastproduct('{0}',{1},{2},{3},{4})", date, productType, cropType, diseaseType, regionId);
        ...
        {
            string str = string.Format("SELECT * FROM f_forecast_getcityforecastproduct('{0}',{1},{2},{3},{4})", date, productType, cropType, diseaseType, regionId);
            return SunGolden.DBUtils.DbHelperPostgresql.ExecuteQuery(str, 1000).Tables[0];
        }
        /// <summary>
        /// 获取县级预报产品数据
        ...
        {
            string str = string.Format("SELECT * FROM f_forecast_getcountyforecastproduct('{0}',{1},{2},{3},{4})", date, productType, cropType, diseaseType, regionId);
            return SunGolden.DBUtils.DbHelperPostgresql.ExecuteQuery(str, 1000).Tables[0];
        }
